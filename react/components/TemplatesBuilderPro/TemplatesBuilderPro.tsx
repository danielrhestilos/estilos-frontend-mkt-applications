                    ...
                    {child?.images?.map((image: any, imgIndex: number) => (
                        <div className={image.main ? styles.contBannerMain: styles.contBanner}  style={{backgroundColor: image.bgColor}} >
                            ...
                            <div className={styles.textBanner}>
                                <p  className={!image.whiteText ? `${styles.hotText}`:`${styles.whiteText} ${styles.hotText}`} >{image?.hotText}</p>
                                <div className={!image.whiteText ?  `${styles.textMessage}`:`${styles.textMessage} ${styles.whiteText}` }
                                    dangerouslySetInnerHTML={{__html: image?.textMessage}}
                                />
                                <p  className={!image.whiteText ?  `${styles.textCTABlack}` : `${styles.textCTAWhite}`} >{image?.textCTA}
                                </p>
                            </div>
                        </div>
                        ))}
            ...
            items: {
                ...
                properties: {
                    ...
                    titlLayout: {
                        ...
                        description: 'Titulo visible del layout de este elemento. Aparece en la parte superior del layout',
                        default: '',
                        type: 'string',
                    },
                    images: {
                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                main:{
                                    ...
                                    description: 'Indicar si el texto tendrá un estilo de banner principal',
                                    type: 'boolean'  
                                },
