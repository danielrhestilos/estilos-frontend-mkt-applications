...
const Warranty = ({
  ...
  const [
    ...
    setRenderProductRecommendations,
  ] = useState([])
  const [isAvailable, setIsAvailable] = useState(false)

  const CSS_HANDLES = ['borderContainer', 'titleContent', 'descriptionContent']
  ...
  useMemo(() => {
    if (sellers) {
      sellers?.map(
        (seller: { commertialOffer: { AvailableQuantity: any } }) => {
          const {
